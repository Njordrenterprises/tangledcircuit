...
import * as $api_aichat from './routes/api/aichat.ts';
import * as $api_images from './routes/api/images.ts';
import * as $api_joke from './routes/api/joke.ts';
import * as $api_systemprompt from './routes/api/systemprompt.ts';
...
const manifest = {
  routes: {
    ...
    './routes/api/aichat.ts': $api_aichat,
    './routes/api/images.ts': $api_images,
    './routes/api/joke.ts': $api_joke,
    './routes/api/systemprompt.ts': $api_systemprompt,
